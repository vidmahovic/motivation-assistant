...
*/
	...
	define('QA_MYSQL_HOSTNAME', 'localhost'); //127.0.0.1
	define('QA_MYSQL_USERNAME', 'adminvid');
	define('QA_MYSQL_PASSWORD', 'admin');
	define('QA_MYSQL_DATABASE', 'motivation_assistant');
