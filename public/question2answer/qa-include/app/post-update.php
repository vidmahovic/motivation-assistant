...
*/
	{
		if (isset($oldquestion['closedbyid'])) {
			...
			//Event::fire(new App\Events\QuestionWasReopened($oldquestion['postid'], $userid, $oldquestion));
		}
	}
...
*/
	{
		...
		Event::fire(new App\Events\QuestionWasClosed($oldquestion['postid'], $userid, 'duplikat', Carbon\Carbon::now()));
...
*/
	{
		...
		Event::fire(new App\Events\QuestionWasClosed($oldquestion['postid'], $userid, $note, Carbon\Carbon::now()));
